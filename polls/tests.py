...
class QuestionModelTests(TestCase):
	def test_was_published_recently_with_future_question(self):
		"""
		the was_published_recently() method returns False for questions whose pub_date
		is in the future
		"""
	...
	def test_was_published_recently_with_old_question(self):
		""" 
		the was_published_recently() returns False for questions whose pub_date
		is older than 1 day	   
	    """
	...
	def test_was_published_recently_with_recent_question(self):
		"""
		the was_published_recently() returns True for questions whose pub_date
...
class QuestionIndexViewTests(TestCase):
	...
	def test_past_question(self):
		"""
		Question with pud_date in the past should be displayed on the page
		"""
